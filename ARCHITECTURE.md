# Sanghavi Mart — Simple Architecture
...
Plain English:
> "Start the Sanghavi Mart server, register routes, and keep the API running."
...
A service answers:
> "What should Sanghavi Mart actually do with this request?"
